...
def add_cart(request,product_id):
    ...
    try:
        ...
        cart.save()
    is_cart_item_exists = CartItemModel.objects.filter(product=product,cart=cart).exists()
    if is_cart_item_exists:
        cart_item = CartItemModel.objects.filter(product=product,cart=cart)
        ex_var_list = []
        id = []
        ...
        if product_variation in ex_var_list:
            ...
            item = CartItemModel.objects.create(product=product,quantity=1,cart=cart)
